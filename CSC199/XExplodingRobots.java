...
class ExplodingRobots {
	...
	public static String canExplode(int x1, int y1, int x2, int y2, String instructions) {
		...
		// Idea:
		// Only execute an insturction if it gets the two robots closer to each other
		// dissmiss the idea of the instuctions not working
		...
		for(int i = 0; i < instructions.length(); i++) {
			...
			*/
			...
			// Always go for the shortest path. Greedy Algorithm
			closest(r1, r2, r3, r4);
		}
